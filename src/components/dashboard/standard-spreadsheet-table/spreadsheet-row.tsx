...
export const SpreadsheetRow = React.memo(({ row, rIdx, columns, selMinR, selMaxR, selMinC, selMaxC, selStart, editCell, onMouseDown, onMouseEnter, onStartEdit, onEndEdit, onSave, isSelectedRow, onSelectRow, onAction, rankingMap, isRankingsLoading, userProfile, disableNamePopover, baseYear }: any) => {
  ...
  if (p.rIdx !== n.rIdx || p.row !== n.row || p.isSelectedRow !== n.isSelectedRow || p.rankingMap !== n.rankingMap || p.isRankingsLoading !== n.isRankingsLoading || p.userProfile !== n.userProfile || p.disableNamePopover !== n.disableNamePopover || p.baseYear !== n.baseYear) return false;
