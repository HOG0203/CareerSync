    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold gap-1.5 sm:gap-2 shadow-lg shadow-indigo-200 text-xs sm:text-sm px-2.5 sm:px-4 h-8 sm:h-10 whitespace-nowrap shrink-0">
          ...
          <span className="hidden sm:inline">성적 데이터 일괄 업로드</span>
          <span className="sm:hidden">성적 업로드</span>
        </Button>
      </DialogTrigger>

      <DialogContent className="max-w-5xl h-[88vh] flex flex-col p-0 border-none shadow-2xl rounded-2xl overflow-hidden">
        {/* 통일된 상단 헤더 */}
          ...
          <div className="flex items-center gap-3.5 text-left justify-start">
            ...
            <div className="flex flex-col items-start text-left">
              <div className="flex items-center gap-2 text-left">
                <DialogTitle className="text-lg sm:text-2xl font-extrabold text-slate-900 tracking-tight text-left">성적 현황 일괄 업로드</DialogTitle>
              ...
              <DialogDescription className="text-slate-500 text-xs sm:text-sm font-medium mt-1 text-left">
                NEIS 성적 엑셀 파일(.xlsx, .xls)을 가져와 학생별 과목 성적 현황을 자동 업로드합니다.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
