...
export interface AuditLogEntry {
  ...
  actor_id?: string;
  actor_name: string;
  action_type: 'STUDENT_UPDATE' | 'STUDENT_BULK_UPDATE' | 'USER_CREATE' | 'USER_ROLE_UPDATE' | 'USER_DELETE' | 'HOMEROOM_ASSIGN' | 'PASSWORD_RESET' | 'COMPANY_UPSERT' | 'COMPANY_DELETE' | 'SYSTEM_SETTING_UPDATE' | 'BASE_YEAR_SNAPSHOT' | 'BASE_YEAR_SNAPSHOT_DELETE' | 'BASE_YEAR_SNAPSHOT_RESTORE';
  target_name: string;
